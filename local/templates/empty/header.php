			...
			<div class="row mx-6 ">
				<div class="col-12">
					<div class="row justify-content-between align-items-center">
							<nav class="navbar navbar-expand-lg navbar-light dcont">
								<div class="logo-block">
									...
									<div class="nav-bank-links ">
										<div class="d-flex">
											<a href="https://ib.skbbank.ru/login" target="_blank">Интернет-банк</a>
											<a class="px-2" href="#">
													<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path d="M9 17C13.4183 17 17 13.4183 17 9C17 4.58172 13.4183 1 9 1C4.58172 1 1 4.58172 1 9C1 13.4183 4.58172 17 9 17Z" stroke="#262626" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
													<path d="M19 19L14.65 14.65" stroke="#262626" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
													</svg>
								...
								<div class="collapse navbar-collapse" id="navbarSupportedContent">
									<ul class="navbar-nav d-flex align-items-center">
										...
										<li class="nav-item px-2 dropdown">
											<a class="nav-link active dropdown-toggle d-flex align-items-center nav-lum-text" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
											Услуги и сервисы
											</a>
						...
						<nav class="navbar navbar-expand-lg navbar-light searh">
							<ul class="navbar-nav d-flex align-items-center">
